  ...
  return (
    <div className="max-w-[1920px] w-[90%] md:w-[80%] mx-auto py-10 md:py-20">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="w-full lg:w-[45%]" data-aos="zoom-in" data-aos-duration="800" suppressHydrationWarning>
        ...
        <div className="w-full lg:w-[50%] cursor-pointer" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="150" suppressHydrationWarning>
