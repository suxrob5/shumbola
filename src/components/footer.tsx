...
const Footer = () => {
  return (
    <div className="max-w-[75%] mx-auto mt-[120px]">
      <div className="flex items-center justify-between">
        ...
        <div className="grid grid-cols-1">
          ...
          <button className="bg-[#a1c9e6] rounded-2xl p-3 mt-2">
            <Link
        ...
        <div className="grid grid-cols-1">
          ...
          <div className="gap-3">
            <button className="bg-[#a1c9e6] rounded-2xl p-3 mt-2 cursor-pointer">
              <Image src={Telegram} alt="tg" width={25} height={25} />
            </button>
            <button className="bg-[#a1c9e6] rounded-2xl p-3 mt-2 cursor-pointer ml-3">
