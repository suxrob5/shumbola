export const translations = {
  ru: {
    ...
    inform: {
      ...
      satisfied: {
        about: "Довольны",
        more: "Все клиенты довольны качеством и обслуживанием.",
      },
      regions: {
        about: "Область",
      ...
      partners: {
        about: "Партнёры",
        more: "Нас выбирают более 50 компаний по всему миру.",
      },
      market: {
        about: "На рынке",
    ...
    discount: {
      noDiscounts: "На данный момент акций нет",
    },
    contact: {
      formTitle: "Оставьте заявку, мы с вами свяжемся",
      fio: "ФИО:",
      phone: "Телефон:",
      email: "Почта:",
      message: "Сообщение:",
  ...
  uz: {
    ...
    inform: {
      sold: {
        about: "Sotilgan",
        more: "Milliondan ortiq mahsulot birliklari sotilgan.",
      },
      satisfied: {
        about: "Mamnun",
        more: "Barcha mijozlar sifat va xizmatdan mamnun.",
      },
      regions: {
        about: "Viloyat",
        more: "Biz 10 ta viloyatga mahsulot eksport qilamiz.",
      },
      partners: {
        about: "Hamkorlar",
        more: "Butun dunyo bo'ylab 50 dan ortiq kompaniya bizni tanlaydi.",
      },
      market: {
        about: "Bozorda",
        more: "Biz 2023 yildan beri har kuni rivojlanib kelmoqdamiz.",
      },
    },
    aboutPage: {
    ...
    discount: {
      noDiscounts: "Hozirda aksiyalar mavjud emas",
    },
    contact: {
      formTitle: "Ariza qoldiring, biz siz bilan bog'lanamiz",
      fio: "F.I.O:",
      phone: "Telefon:",
      email: "Pochta:",
      message: "Xabar:",
  ...
  en: {
    ...
    inform: {
      sold: {
        about: "Sold",
        more: "More than a million units of products sold.",
      },
      satisfied: {
        about: "Satisfied",
        more: "All customers are satisfied with quality and service.",
      },
      regions: {
        about: "Regions",
        more: "We export products to 10 regions.",
      },
      partners: {
        about: "Partners",
        more: "More than 50 companies worldwide choose us.",
      },
      market: {
        about: "On market",
        more: "We have been working since 2023, developing every day.",
      },
    },
    aboutPage: {
    ...
    discount: {
      noDiscounts: "There are no promotions at the moment",
    },
    contact: {
      formTitle: "Leave a request, we will contact you",
      fio: "Full Name:",
      phone: "Phone:",
      email: "Email:",
      message: "Message:",
